 ...
 * @Last Modified time: 2018-02-23 18:04:33
 *
 * 【功能】
 * 自动加载类文件
 * 检测开发环境
...
class VSF
{
    ...
    // 方式2：(舍弃) 使用 restful 风格，最终也会转换为方式1
    // 例：http://localhost/demo/item/index/csxiaoyao/sunshine
    // 注意点：无入口文件名
    // 
    // 新：使用 restful 风格，结合 apache/nginx 路由规则使用
    // 例： location ^~ /php/
    //     RewriteRule ^php/(\S*)$   index.php [nc,qsa]
    // https://csxiaoyao.cn/php/route/link/db/otherparam
    // 
    public function route()
    {
        ...
        */
        ...
        call_user_func_array(array($dispatch, $actionName), $urlArray);
    }
